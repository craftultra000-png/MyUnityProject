Shader "Hidden/lilToonFurCutout" {
	Properties {
		...
		[lilToggle] _ZWrite ("ZWrite", Float) = 1
		...
		[lilToggle] _AlphaToMask ("sAlphaToMask", Float) = 1
		...
		[lilVec3Float] _FurVector ("sFurVectors", Vector) = (0,0,1,0.02)
		[lilToggle] _VertexColor2FurVector ("sVertexColor2Vector", Float) = 0
		_FurGravity ("sGravity", Range(0, 1)) = 0.25
		_FurRandomize ("sRandomize", Float) = 0
		_FurAO ("sAO", Range(0, 1)) = 0
		[lilEnum] _FurMeshType ("Mesh Type|Subdivision|Shrink", Float) = 1
		...
		_FurRimColor ("sColor", Vector) = (0,0,0,1)
		[PowerSlider(3.0)] _FurRimFresnelPower ("sFresnelPower", Range(0.01, 50)) = 3
		_FurRimAntiLight ("sAntiLight", Range(0, 1)) = 0.5
		[lilEnum] _FurCull ("sCullModes", Float) = 0
		[Enum(UnityEngine.Rendering.BlendMode)] _FurSrcBlend ("sSrcBlendRGB", Float) = 1
		[Enum(UnityEngine.Rendering.BlendMode)] _FurDstBlend ("sDstBlendRGB", Float) = 0
		[Enum(UnityEngine.Rendering.BlendMode)] _FurSrcBlendAlpha ("sSrcBlendAlpha", Float) = 1
		[Enum(UnityEngine.Rendering.BlendMode)] _FurDstBlendAlpha ("sDstBlendAlpha", Float) = 10
		[Enum(UnityEngine.Rendering.BlendOp)] _FurBlendOp ("sBlendOpRGB", Float) = 0
		[Enum(UnityEngine.Rendering.BlendOp)] _FurBlendOpAlpha ("sBlendOpAlpha", Float) = 0
		[Enum(UnityEngine.Rendering.BlendMode)] _FurSrcBlendFA ("sSrcBlendRGB", Float) = 1
		[Enum(UnityEngine.Rendering.BlendMode)] _FurDstBlendFA ("sDstBlendRGB", Float) = 1
		[Enum(UnityEngine.Rendering.BlendMode)] _FurSrcBlendAlphaFA ("sSrcBlendAlpha", Float) = 0
		[Enum(UnityEngine.Rendering.BlendMode)] _FurDstBlendAlphaFA ("sDstBlendAlpha", Float) = 1
		[Enum(UnityEngine.Rendering.BlendOp)] _FurBlendOpFA ("sBlendOpRGB", Float) = 4
		[Enum(UnityEngine.Rendering.BlendOp)] _FurBlendOpAlphaFA ("sBlendOpAlpha", Float) = 4
		[lilToggle] _FurZClip ("sZClip", Float) = 1
		[lilToggle] _FurZWrite ("sZWrite", Float) = 1
		[Enum(UnityEngine.Rendering.CompareFunction)] _FurZTest ("sZTest", Float) = 4
		...
		[lilColorMask] _FurColorMask ("sColorMask", Float) = 15
		[lilToggle] _FurAlphaToMask ("sAlphaToMask", Float) = 1
	}
