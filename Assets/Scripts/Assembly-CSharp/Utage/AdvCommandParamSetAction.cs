...
namespace Utage
{
	public class AdvCommandParamSetAction : AdvCommand
	{
		...
		public AdvCommandParamSetAction(StringGridRow row)
			: base(row)
		{
		...
		public override void DoCommand(AdvEngine engine)
		{
			...
			{
				Debug.LogWarning("AdvCommandParam SetAction Parameter Name: " + paramArg1 + " action:" + paramArg2);
			}
			if (_actionCore == null)
			{
			...
			_actionCore.AnimationSet(paramArg1, paramArg2);
		}
	}
}
