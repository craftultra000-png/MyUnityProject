...
namespace Utage
{
	public class AdvCommandParamSetMovePoint : AdvCommand
	{
		...
		public AdvCommandParamSetMovePoint(StringGridRow row)
			: base(row)
		{
		...
		public override void DoCommand(AdvEngine engine)
		{
			...
			{
				Debug.LogWarning("AdvCommandParam SetMovePoint Parameter Name: " + paramArg1 + " action:" + paramArg2);
			}
			...
			_walkPointCore.CharacterMoveSet(paramArg1, paramArg2);
		}
	}
}
