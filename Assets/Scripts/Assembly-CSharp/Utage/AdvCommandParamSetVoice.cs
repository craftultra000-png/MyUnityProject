...
namespace Utage
{
	public class AdvCommandParamSetVoice : AdvCommand
	{
		...
		public AdvCommandParamSetVoice(StringGridRow row)
			: base(row)
		{
		...
		public override void DoCommand(AdvEngine engine)
		{
			...
			{
				Debug.LogWarning("AdvCommandParam SetBreath  Parameter Name: " + paramArg1 + " Breath:" + paramArg2);
			}
			if (_actionCore == null)
			{
			...
			_actionCore.SetVoice(paramArg1, paramArg2);
		}
	}
}
