...
namespace Utage
{
	public class AdvCommandParamSetAIUEO : AdvCommand
	{
		...
		public AdvCommandParamSetAIUEO(StringGridRow row)
			: base(row)
		{
		...
		public override void DoCommand(AdvEngine engine)
		{
			...
			{
				Debug.Log("AdvCommandParam SetAIUEO Parameter Name: " + paramArg1 + " AIUEO Count:" + paramArg2);
			}
			if (_actionCore == null)
			{
			...
			_actionCore.SetAIUEO(paramArg1, int.Parse(paramArg2));
		}
	}
}
